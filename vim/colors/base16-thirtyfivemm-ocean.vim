...
" thirtyfivemm-ocean scheme by Arun Seehra (seehra.a@gmail.com)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-thirtyfivemm-ocean.sh"
  endif
endif
...
if has("nvim")
  ...
  let g:terminal_color_4 =  "#b48ead"
  let g:terminal_color_5 =  "#81a2be"
...
hi clear
syntax reset
let g:colors_name = "base16-thirtyfivemm-ocean"
...
call <sid>hi("StatusLineNC",    s:gui04, s:gui02, s:cterm04, s:cterm02, "none", "")
